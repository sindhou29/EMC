...
public class EMCPSOBudgetUpload {
	...
	public void sendExceptionNotification(Map<String, Object> variableMap) {
		...
		content.append("File Name: " + utilityFunctions.returnEmptyStringForNulls((String)filename) + "\n");
		for(Map m : eventList) {
			content.append("File Upload Date and Time: " + m.get("uploaded_date") + "\n");
			content.append("Settlement Date: " + m.get("settlement_date") + "\n");
			content.append("File Upload User: " + utilityFunctions.returnEmptyStringForNulls((String)m.get("uploaded_by")) + "\n");
			content.append("User Comments: " + utilityFunctions.returnEmptyStringForNulls((String)m.get("comments")) + "\n");
			content.append("Validated Time: " + m.get("validated_date") + "\n");
			content.append("Valid: " + utilityFunctions.returnEmptyStringForNulls((String)m.get("valid_yn")) + "\n");
		}
