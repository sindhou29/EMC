...
public class ForwardSalesContractUploadMain {
	...
	public void sendExceptionNotification(Map<String, Object> variableMap) {
		...
		for (Map eventMap : eventList) {
			...
			content.append("File Upload User: " + utilityFunctions.returnEmptyStringForNulls(uploadUser) + "\n\n");
			content.append("User Comments: " + utilityFunctions.returnEmptyStringForNulls((String)eventMap.get("comments")) + "\n\n");
			content.append("Validated Time: " + eventMap.get("validated_date") + "\n\n");
			content.append("Valid: " + utilityFunctions.returnEmptyStringForNulls((String)eventMap.get("valid_yn")) + "\n\n");
		}
